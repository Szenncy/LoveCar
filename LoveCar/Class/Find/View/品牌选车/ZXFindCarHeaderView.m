...
@interface ZXFindCarHeaderButton : UIButton

@end

@implementation ZXFindCarHeaderButton
...
@interface ZXFindCarHeaderView ()
{
   ...
   UILabel *_cheapRangeLabel;
    ...
    /** 问最低价 */
    ZXFindCarHeaderButton *_lowestPriceBtn;
    
    /** 拨打电话 */
    ZXFindCarHeaderButton *_dealerTelBtn;
}

@end

@implementation ZXFindCarHeaderView
...
- (instancetype)initHeaderViewWithSeriesImage:(NSString *)seriesImage carName:(NSString *)carName cheapRange:(NSString *)cheapRange dealerName:(NSString *)dealerName {
    ...
    if (self) {
        ...
        [_cheapRangeLabel setTextColor:ZXColor(241, 79, 86)];
        ...
        [_dealerNameLabel setTextColor:ZXColor(135, 136, 145)];
        ...
        /** 问最低价 */
        _lowestPriceBtn = [[ZXFindCarHeaderButton alloc] init];
        [_lowestPriceBtn setBackgroundColor:ZXColor(40, 177, 229)];
        ...
        /** 拨打电话 */
        _dealerTelBtn = [[ZXFindCarHeaderButton alloc] init];
        [_dealerTelBtn setBackgroundColor:ZXColor(40, 177, 229)];
