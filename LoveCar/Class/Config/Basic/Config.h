...
// 设置颜色
#define ZXColor(r, g, b) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:1.0f]
#define ZXAColor(r, g, b, a) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:(a)]
...
#define kSelectedPostListURL @"http://mi.xcar.com.cn/interface/xcarapp/getSelectedPostList.php"
...
#define kGetForumCarURL @"http://mi.xcar.com.cn/interface/xcarapp/getForumList.php?type=0&ver=6.0.3http://mi.xcar.com.cn/interface/xcarapp/getPostInfo.php?tid=21586648&type=0&uid=&version=6.0.3"

#define kGetForumLifeURL @"http://mi.xcar.com.cn/interface/xcarapp/getForumList.php?type=2&ver=6.0.3"

#define kGetForumInfoURL @"http://mi.xcar.com.cn/interface/xcarapp/getForumInfo.php"

#define kGetPostListNew @"http://mi.xcar.com.cn/interface/xcarapp/getPostListNew.php"

#define PARAM @"param"

#define FORUMID @"forumId"
